...
QT_MOC_LITERAL(1, 15, 12), // "rightClicked"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "MyGraphicsView\0rightClicked\0"
};
...
void MyGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGraphicsView::rightClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGraphicsView::rightClicked()
{
