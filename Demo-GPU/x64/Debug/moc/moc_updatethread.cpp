...
QT_MOC_LITERAL(1, 13, 13), // "sig_sendState"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 3), // "msg"
QT_MOC_LITERAL(4, 32, 4) // "flag"

    },
    "UpDateThread\0sig_sendState\0\0msg\0flag"
};
...
void UpDateThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_sendState((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (UpDateThread::*)(QString , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UpDateThread::sig_sendState)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject UpDateThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_UpDateThread.data,
...
// SIGNAL 0
void UpDateThread::sig_sendState(QString _t1, bool _t2)
{
